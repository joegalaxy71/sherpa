...
func terminalCD() {
	...
	queryField = tview.NewInputField().SetLabel("[white]isearch ").SetChangedFunc(updateList)
	queryField.SetInputCapture(interceptInputField)
	...
	prompts.SetInputCapture(interceptTable).SetBorder(true)
